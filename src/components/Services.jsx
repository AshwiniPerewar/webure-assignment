    ...
    <div class="mt-16">
        ...
        <div class="flex justify-between space-x-14 ">
            <div class="w-18 mt-3">
                ...
                <p class="text-xs mt-3 text-stone-400">We will bring the breathe of our experience and industry knowledge to help you succeed</p>
            </div>
            ...
            <i class="fa-solid fa-calendar-check text-blue-500 text-3xl"></i>
                ...
                <p class="text-xs mt-3 text-stone-400">Leverage agile framework to provide a robust high level synopsys overviews</p>
            </div>
            <div class="w-18 mt-3">
