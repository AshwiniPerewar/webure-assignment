...
const Projects = () => {
  return (
    <div class="grid grid-cols-3 gap-6  p-10">
      ...
      <div class="space-y-2">
        <img class="h-18" src="https://idapgroup.com/blog/blog/wp-content/uploads/2021/10/image6.png"></img>
      ...
      <p class="text-sm text-center">SEO Marketing 4.0</p>
        ...
        <button class="border-red-300 border-2 rounded-3xl pl-2  h-10 mt-4 w-32 text-xs hover:bg-red-600">See More</button>
</div></div>
  )
}
